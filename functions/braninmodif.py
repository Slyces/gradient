...
@function
def braninmodif(xx=None,a=None,b=None,c=None,r=None,s=None,t=None,*args,**kwargs):
    varargin = braninmodif.varargin
    nargin = braninmodif.nargin
